...
3. Invite the bot to your server by generating an invite link from the `OAuth2` section. Select the bot scope and the following permissions: `Read Message History`, `Send Messages`, `Embed Links`, `View Channels`.
